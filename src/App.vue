...
<template>
    <div class="md:p-10 h-screen w-full overflow-hidden">
        <div class="flex flex-row md:min-h-[576px] md:max-h-[576px]">
            ...
            >
                <collapse-menu class="flex flex-col pb-2 border-b border-slate-200">
                    ...
                    <input
                        class="placeholder:text-slate-400 text-slate-800 rounded-md border border-slate-200 py-2 px-4 mt-2 w-full"
                        type="search"
                        placeholder="Search"
                    />
                    <div class="my-2">
                ...
                <collapse-menu class="flex flex-col pb-2 border-b border-slate-200">
                    ...
                    <div class="my-2">
                        <div>
                            <div
                                v-for="n in ['Major', 'Maid major', 'minor', 'Kraken', 'super minor']"
                                :key="n"
                                class="flex justify-between items-center py-2"
                            >
                                <label
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="flex flex-col flex-1">
                                    ...
                                    <div class="flex flex-row items-center">
                                        ...
                                        <span class="uppercase text-slate-400 text-xs ml-2">usdt</span>
                                    </div>
                                </div>
                                <div>
                                    <div
                            ...
                            >
                                ...
                                <div class="flex flex-row justify-between">
                                    <span class="text-[10px] text-slate-800">Minor Pivot Type</span>
                                    <div class="flex flex-row items-center">
                                        <span class="text-[10px] text-slate-400 mr-1.5" v-text="match.time"></span>
                                        <svg
                                            class="fill-teal-500"
                                            width="12"
                                            height="6.009"
